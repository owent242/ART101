var questions = [
  {
    ...
    options: [
      { label: "Sad / Low",       value: "sad" },
      { label: "Energized",       value: "energized" },
      { label: "Calm",            value: "calm" },
      { label: "Hype / Excited",  value: "hype" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Pop / Electronic",    value: "electronic" },
      { label: "Indie / Alternative", value: "indie" },
      { label: "Rock / Metal",        value: "rock" }
    ]
  },
  {
...
var moodDB = {
  ...
  "energized+workout+uplifting+electronic+max": {
    title: "Beast Mode",
    desc: "Turn it up. You've got this.",
    playlists: [
  ...
  "default": {
    ...
    playlists: [
      { name: "Today's Top Hits", meta: "Spotify Editorial", link: "https://open.spotify.com/playlist/37i9dQZF1DXcBWIGoYBM5M" },
...
function showResults() {
  ...
  for (var i = 0; i < mood.playlists.length; i++) {
    ...
    card.href = p.link;
    card.target = '_blank';
    card.innerHTML = '<h4>' + p.name + '</h4><p>' + p.meta + '</p>';
